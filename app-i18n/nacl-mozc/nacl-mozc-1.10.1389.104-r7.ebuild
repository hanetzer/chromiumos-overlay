...
internal? ( gs://chromeos-localmirror-private/distfiles/nacl-mozc-1.10.1402.4.tgz )"
...
src_prepare() {
	...
	if use internal; then
		...
		epatch "${FILESDIR}"/nacl-mozc-1.10.1402.4-insert-internal-public-key.patch
		epatch "${FILESDIR}"/nacl-mozc-1.10.1402.4-call-startIme.patch
		epatch "${FILESDIR}"/nacl-mozc-1.10.1402.4-option-page-design.patch
		epatch "${FILESDIR}"/nacl-mozc-1.10.1402.4-support-onreset-event.patch
	else
