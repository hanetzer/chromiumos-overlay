...
internal? ( gs://chromeos-localmirror-private/distfiles/nacl-mozc-1.10.1404.4.tgz )"
...
src_prepare() {
	...
	if use internal; then
		...
		epatch "${FILESDIR}"/nacl-mozc-1.10.1404.4-insert-internal-public-key.patch
		epatch "${FILESDIR}"/nacl-mozc-1.10.1404.4-call-startIme.patch
	else
