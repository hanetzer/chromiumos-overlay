...
src_prepare() {
	...
	use cacert && epatch "${FILESDIR}/${PN}-cacert-class3.patch" # 521462
	...
	# Backport patches from NSS 3.20.1 for https://bugzil.la/1202868 and
	# https://bugzil.la/1192028
	epatch "${FILESDIR}"/${PN}-3.20-chromeos-backport.patch
