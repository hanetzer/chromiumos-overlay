...
GIT_SHA1="68331f31aa8b7708720d36322ed7d12e42ca9d78"
MY_P=${PN}-68331f3
...
src_install() {
	...
	newins QCA988X/10.2.4/firmware-5.bin_10.2.4.70.22-2 firmware-5.bin
	newins QCA988X/10.2.4/notice.txt_10.2.4.70.22-2 notice.txt
}
