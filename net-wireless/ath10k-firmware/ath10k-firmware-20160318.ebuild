...
GIT_SHA1="9fffffd697597d023dc9ae37dac3c0bb3af2cf34"
MY_P=${PN}-9fffffd
...
src_install() {
	...
	newins QCA988X/10.2.4/firmware-5.bin_10.2.4.70.31-2 firmware-5.bin
	newins QCA988X/10.2.4/notice.txt_10.2.4.70.31-2 notice.txt
}
