...
GIT_SHA1="b00eb8d30fbebb6a5047ccacefa8c37e072fca9c"
MY_P=${PN}-b00eb8d
...
src_install() {
	...
	newins QCA988X/10.2.4/firmware-5.bin_10.2.4.70.44 firmware-5.bin
	newins QCA988X/10.2.4/notice.txt_10.2.4.70.44 notice.txt
}
