...
GIT_SHA1="3f44d0368a2d44b389246d8db65a310b09c2f999"
MY_P=${PN}-3f44d03
...
src_install() {
	...
	newins QCA988X/10.2.4/firmware-5.bin_10.2.4.70.52 firmware-5.bin
	newins QCA988X/10.2.4/notice.txt_10.2.4.70.52 notice.txt
}
