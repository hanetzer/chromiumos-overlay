...
GIT_SHA1="1a375ea191dba3900b7432b465aaa51939c2dd0a"
MY_P=${PN}-1a375ea
...
src_install() {
	...
	newins QCA988X/10.2.4/firmware-5.bin_10.2.4.70.54 firmware-5.bin
	newins QCA988X/10.2.4/notice.txt_10.2.4.70.54 notice.txt
}
