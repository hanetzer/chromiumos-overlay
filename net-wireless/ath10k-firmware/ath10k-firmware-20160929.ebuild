...
GIT_SHA1="75ae958bedb3528a597662a605dbb958a34c33ed"
MY_P=${PN}-75ae958
...
src_install() {
	...
	newins QCA988X/hw2.0/10.2.4.70/firmware-5.bin-10.2.70.56 firmware-5.bin
	newins QCA988X/hw2.0/10.2.4.70/notice.txt_10.2.4.70.54 notice.txt
}
