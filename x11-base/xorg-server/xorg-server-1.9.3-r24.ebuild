...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.9.2.ebuild,v 1.3 2010/12/19 13:07:34 ssuominen Exp $
...
IUSE="${IUSE_SERVERS} -doc ipv6 minimal nptl tslib +udev opengl vanilla"
...
PATCHES=(
	...
	"${FILESDIR}/chromium-mouse-accel-profile.patch"
	# Ability to run without root privs
	"${FILESDIR}/1.9.3-nohwaccess.patch"
	)
